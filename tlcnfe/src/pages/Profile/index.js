...
const Profile = () => {
    ...
    const handleEdit = () => {
        nav(router.editProfile)
    }
    return (
        <div className="h-full overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                <div className="relative flex justify-center items-center z-30 mx-auto -mt-[88px] h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
                    <div className="relative drop-shadow-2">
                        <img src="https://react-demo.tailadmin.com/assets/user-06-00406fb8.png" alt="profile" />
                        <label
                            htmlFor="profile"
                ...
                <div className="mt-4">
                    ...
                    <p className="font-medium">{currentUser?.data?.address}</p>
