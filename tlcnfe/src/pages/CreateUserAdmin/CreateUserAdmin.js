...
function CreateUserAdmin() {
    ...
    const handleEditProfile = async () => {
        if (name === '' || address === '' || email === '' || phone === '' || birthday === '' || password === '' || startWork === '') {
            ...
            if (password !== confirmPassword) {
                ...
                const data = await authApi.addUser({
                    userName: uername,
                    fullName: name,
    ...
    return (<div className="h-full overflow-hidden rounded-sm mx-3 py-5 relative">
        <div>
            ...
            <div className="w-full flex justify-between items-center flex-wrap">
                <div className="flex justify-between items-center w-[48%] p-3 my-3">
                    ...
                    <input className="w-[85%] p-2 border rounded-lg" type="text" placeholder='Họ và tên' value={uername} onChange={(e) => setUsername(e.target.value)} />
                </div>
                <div className="flex justify-between items-center w-[48%] p-3 my-3">
                ...
                <div className="flex justify-between items-center w-[48%] p-3">
                    ...
                    <input className="w-[85%] p-2 border rounded-lg" type="date" placeholder="Sinh nhật" onChange={(e) => setStartWork(e.target.value)} />
                </div>
                <div className="flex justify-between items-center w-[48%] p-3">
                    <p className="w-[15%]">Ngày kết thúc</p>
                    <input className="w-[85%] p-2 border rounded-lg" type="date" placeholder="Sinh nhật" onChange={(e) => setEndWork(e.target.value)} />
                </div>
                <div className="flex justify-between items-center w-[48%] p-3">
